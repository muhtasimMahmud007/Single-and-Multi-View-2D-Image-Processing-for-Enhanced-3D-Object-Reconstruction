...
from models.encoder import Encoder1, Encoder2
from models.decoder import Decoder
from models.refiner import Refiner
from models.merger import Merger
from models.ensemble import MetaModel, StackedEncoder
...
def test_net(cfg,
    ...
    if decoder is None or encoder is None:
        encoder1 = Encoder1(cfg)
        encoder2 = Encoder2(cfg)
        feature_size = 256  # Assuming 256 feature maps from each encoder
        height, width = 7, 7  # Assuming feature maps of size 7x7 from each encoder
        input_dim = feature_size * height * width * 2 * cfg.CONST.N_VIEWS_RENDERING  # 2 for concatenation
        output_dim = feature_size * height * width
        meta_model = MetaModel(input_dim=input_dim, output_dim=output_dim)  # Adjust the input and output dimensions accordingly
        encoder = StackedEncoder(encoder1, encoder2, meta_model, feature_size, height, width)
