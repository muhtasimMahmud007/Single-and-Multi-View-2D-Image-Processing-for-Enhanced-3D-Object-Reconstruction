...
class Decoder(torch.nn.Module):
    def __init__(self, cfg):
        ...
        self.layer1 = torch.nn.Sequential(
            torch.nn.ConvTranspose3d(32, 512, kernel_size=4, stride=2, bias=cfg.NETWORK.TCONV_USE_BIAS, padding=1),
    ...
    def forward(self, image_features):
        # print(image_features.size())  # torch.Size([batch_size, n_views, 2048, 2, 2, 2])
        ...
        for features in image_features:
            gen_volume = features.view(-1, 32, 2, 2, 2)
