...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = 'D://plusplus//Pix2Vox//SMATS//datasets//SMATSNet.json'
# __C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH  = './datasets/PascalShapeNet.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = 'C://Users//20301470//Downloads//dataset//SMATSNet_rendering//%s//%s//%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = 'C://Users//20301470//Downloads//dataset//SMATSNet_vox//%s//%s//model.binvox'
...
#__C.CONST.WEIGHTS = 'D://plusplus//Pix2Vox//ensemble//output//checkpoints//2024-05-16T19-32-40.656242//checkpoint-epoch-220.pth'
#
# Directories
#
__C.DIR                                     = edict()
